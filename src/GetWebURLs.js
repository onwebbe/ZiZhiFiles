    ...
    async.eachLimit(companyNameList, 1, function(companyName, callback) {
      ...
      superagent.get(url).
        ...
        set('Cookie', ServerCookie). // 随便论坛里的一个地址
          ...
          logger.info('Got data:' + searchItem.length);
          if (searchItem.length > 0) {
            ...
            logger.info('Update: ' + companyName + ' URL: ' + companyURL);
      ...
      if ( err ) {
        ...
        logger.error('All files have been processed successfully');
      }
    });
  }
