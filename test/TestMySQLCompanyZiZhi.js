...
describe('Test MySQLCompanyZiZhi', function() {
  ...
  pickTestMatrix.test1('UnitTest: create connection, status flag should be true', function() {
    zizhiDB.createConnection();
    assert.equal(zizhiDB.isConnected, true);
    sinon.restore();
  });

  pickTestMatrix.test2('UnitTest: when startTransaction, connection should be active and active trasaction count should be 1', function() {
  ...
  it('UnitTest: when endTransaction after startTransaction, connection should be active and active trasaction count should be 0', function() {
  ...
  it('UnitTest: Check data in the list', function() {
    let list = [];
    list.push('field1');
    list.push('field2');
    list.push('field3');
  ...
  it('UnitTest: when execute queryComplex, could compose a proper query to execute', async function() {
  ...
  it('UnitTest: when execute queryDB using and, could compose a proper query to execute and returns the db result', async function() {
  ...
  it('UnitTest: when execute queryDB using or, could compose a proper query to execute and returns the db result', async function() {
    let tablename = 'tablename';
    let queryData = {
      'field1': 'value1',
      'field2': 'value2'
  ...
  it('UnitTest: when execute queryDB with no tablename, error will be returned', async function() {
    let queryData = {
      'field1': 'value1',
      'field2': 'value2'
    };
  ...
  it('UnitTest: when execute insertDB, will generate proper query to insert', async function() {
    let tablename = 'tablename';
    let insertData = {
  ...
  it('UnitTest: when execute insertDB, but dedup check get one record', async function() {
    let tablename = 'tablename';
    let insertData = {
      'insertfield1': 'insertvalue1',
      'insertfield2': 'insertvalue2',
  ...
  it('UnitTest: when execute updateDB, system will execute update properly', async function() {
    let tablename = 'tablename';
    let updateData = {
      'insertfield1': 'insertvalue1',
      'insertfield2': 'insertvalue2',
  ...
  it('UnitTest: when execute updateDB no exclude field, system will execute update properly', async function() {
    let tablename = 'tablename';
    let updateData = {
      'insertfield1': 'insertvalue1',
      'insertfield2': 'insertvalue2',
  ...
  it('UnitTest: when close the connection, status flag should be false', function() {
